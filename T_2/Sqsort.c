...
main(int argc, char** argv)
{
    ...
    else
    {
        ...
        //double a = (double)ceil((tam_vetor)/2);
        //printf("####################TAM_VETOR!!!!! ----- %f\n",(double)ceil((tam_vetor)/2));
        ...
        if (tam_vetor%2 != 0){
            //printf("ENTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTROU: %d\n",tam_vetor);
            tam2 = (tam_vetor+1)/2;
        }

        printf("####################TAM_VETOR!!!!! ----- TAM1: %d TAM2:%d\n",tam1,tam2);
